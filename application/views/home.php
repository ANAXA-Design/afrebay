        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="blog-sec">
                        <div class="row">
                            <?php if(!empty($get_post)){ foreach($get_post as $row){
                            ...
                            <div class="col-lg-4">
                                <div class="my-blog" onclick="location.href='<?= base_url('postdetail/'.base64_encode($row->id))?>';">
                                    <div class="blog-details">
                                        <h3 class="resk">
                                            <a 
                                                title=""><?= ucfirst($row->post_title)?>
                                            </a>
                                        </h3>
                                        <h3 class="nkash">
                                            <a href="javascript:void(0)" title="">Description</a>
                                        </h3>
                                        <p>
                                            <?= ucfirst($desc)?>
                                        </p>
                    ...
                    <div class="blog-sec">
                        <div class="row">
                            ...
                            if(!empty($get_users)){ foreach($get_users as $user){
                                 ...
                                 if(strlen($user->short_bio)>100)
          {
            $shortbio=substr($user->short_bio,0,100).'...';
          }
          else {
                            ...
                            <div class="col-lg-4">
                                <div class="my-blog">
                                    <div class="blog-thumbak">
                                        <a href="<?= base_url('worker-detail/'.base64_encode(@$user->userId))?>"
                                            ...
                                            <img src="<?=base_url('uploads/users/'.$user->profilePic); ?>" alt=""
                                                style="height: 300px;" />
                                            <?php } else{?>
                                            <img src="<?=base_url('uploads/users/675_nouser.jpg'); ?>" alt=""
                                                style="height: 300px;" />
                                            <?php } ?>
                                        </a>
                                    </div>
                                    <div class="blog-details">
                                        ...
                                        <div class="staak">
                                            <span><?= !empty($user->rate)?round($user->rate):'0';?> Star
                                                AfreBay</span>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="cat-sec">
                        <div class="row no-gape">
                            <?php if(!empty($get_ourservice)){ foreach($get_ourservice as $item){
        ...
        <div class="container Job">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="blog-sec">
                        <div class="row">
                            <?php if(!empty($get_freelancerspost)){ foreach($get_freelancerspost as $post){
            ...
            $description=$post->description;
                            ...
                            <div class="col-lg-3">
                                <div class="my-blog">
                                    ...
                                    <!--    <a href="<?= base_url('postdetail/'.base64_encode($post->id))?>" title=""><img src="<?=base_url(); ?>assets/images/resource/b6.jpg" alt="" /></a>-->
                                    <!--    <div class="blog-metas">-->
                                    <!--        <a href="<?= base_url('postdetail/'.base64_encode($post->id))?>" title="">$<?= $post->charges?></a>-->
                                    <!--        <a href="<?= base_url('postdetail/'.base64_encode($post->id))?>" title=""><?= $post->duration?></a>-->
                                    <!--    </div>-->
                                    <!--</div>-->
                                    <div class="blog-details">
                                        <h3><?= ucfirst($post->post_title)?> </h3>
                                        <p><?= $description?></p>
                                        <a href="<?= base_url('postdetail/'.base64_encode($post->id))?>"
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <!-- Heading -->
                    <div class="comp-sec">
                        <?php if(!empty($get_company)){ foreach($get_company as $item){?>
