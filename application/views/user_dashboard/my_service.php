                           ...
                           <div class="user-dashboard">
                               <div class="row row-sm">
                                  <div class="col-xl-12 col-lg-12 col-md-12" style="margin-bottom: 10px;">
                                   <a href="<?php echo base_url('addservice')?>" class="btn btn-primary" style="float:right;">Add service</a>
                                  </div>
                                             ...
                                             <tbody>
                                               ...
                                               <tr>
                                                 ...
                                                 <td>
                                                   ...
                                                   <a href="<?= base_url('user/dashboard/update_service_form/'.base64_encode($row->id));?>"><i class="fa fa-edit" aria-hidden="true"></i></a>
                                                   <a href="<?= base_url('user/Dashboard/delete_service/'.$row->id);?>" onclick="if(confirm('Are you sure you want to Delete?')) commentDelete(1); return false"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                                 </td>
                                               </tr>
                                             <?php $i++;}  }else{?>
                                               <tr>
